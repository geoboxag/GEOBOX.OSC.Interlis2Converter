...
namespace GEOBOX.OSC.Interlis2Converter.ConsoleApp.Batch
{
    ...
    public sealed class CommandLineOptions
    {
        ...
        /// </summary>
        [Option('i', "inputDir", HelpText = "Angabe des Verzeichnispfades mit den Interlis (XTF) Dateien zum Zusammenführen.", Required = true)]
        public string InputDir { get; set; }

        /// <summary>
        /// Name of the file without file extension
        /// </summary>
        [Option('o', "outputFile", HelpText = "Angabe des Pfades und des Datei-Namens (inkl. Dateiendung) für das Zusammengeführte Interlis (XTF-Datei).", Required = true)]
        public string OutputFile { get; set; }

        /// <summary>
        /// Full path and filename without file extension
        /// </summary>
        [Option('l', "logFile", HelpText = "Angabe des Pfades und des Datei-Namens (inkl. Dateiendung) für die Protokoll-Datei.", Required = true)]
